...
//	{ .wintype = "_KDE_NET_WM_WINDOW_TYPE_OVERRIDE", .flags = Unmanaged },
	...
	{ .instance = "spterm (w)", .scratchkey = 'w', .flags = Floating, .floatpos = "50% 50% 50% 50%" },
	{ .instance = "spterm (e)", .scratchkey = 'e', .flags = Floating, .floatpos = "50% 50% 50% 50%" },
...
static const char *spcmd_r[] = {"r", "kitty", "--name", "spfmran", "-e", "/home/uwuty/.dotfiles/.ranger", NULL };
