...
static int bar_height                    = 23;   /* 0 means derive from font, >= 1 explicit height */
...
static double moveopacity                = 0.6;   /* client opacity when being moved, 0 means don't apply opacity */
static double resizeopacity              = 0;   /* client opacity when being resized, 0 means don't apply opacity */
static double placeopacity               = 0.6;   /* client opacity when being placed, 0 means don't apply opacity */
...
static const char *const autostart[] = {
    ...
    "mako", NULL,
    "numlockx", NULL,
    "sh", "-c", "~/scripts/.fehbg", NULL,
    "/usr/lib/polkit-gnome/polkit-gnome-authentication-agent-1", NULL,
    "xset", "r", "rate", "240", "37", NULL,
    "setxkbmap", "-layout", "us,ru", "-option", "grp:shifts_toggle", NULL,
    "sh", "-c", "Telegram -startintray", NULL,
//    "sh", "-c", "xsetroot -LyraB-cursors left_ptr", NULL,
//    "sh", "-c", "sudo timedatectl set-ntp true", NULL,
    "sh", "-c", "xset s off -dpms", NULL,
    "sh", "-c", "xsetroot -Night Diamond (Blue) left_ptr",
    NULL /* terminate */
};
...
//	{ .wintype = "_KDE_NET_WM_WINDOW_TYPE_OVERRIDE", .flags = Unmanaged },
	...
	{ .instance = "spterm (w)", .scratchkey = 'w', .flags = Floating, .floatpos = "50% 20% 60% 60%" },
	{ .instance = "spterm (e)", .scratchkey = 'e', .flags = Floating, .floatpos = "50% 20% 60% 60%" },
	{ .instance = "spfmran", .scratchkey = 'r', .flags = Floating, .floatpos = "50% 50% 92% 90%" },
	{ .class = "Gimp", .workspace = "5", .flags = Floating|SwitchWorkspace },
  	{ .instance = "Telegram", .scratchkey = 't', .flags = Floating|Centered, .floatpos = "50% 50% 80% 85%" },
  	{ .instance = "discord", .scratchkey = 'y', .flags = Floating|Centered, .floatpos = "50% 50% 92% 90%"},
    { .instance = "term-pulsemixer", .scratchkey = 'v', .flags = Floating, .floatpos = "50% 20% 60% 60%"},
	...
	{ .class = "steam_app_", .flags = SteamGame|Floating|Centered },
  	{ .class = "v2rayN", .workspace = "10", .flags = SwitchWorkspace},
...
static BarDef bars[] = {
	...
	{  0,      1,   0,    "0%    100%   100% 23h ", "Primary bottom" },
	{  1,      0,   0,    "0%    0%     100% -1h ", "Secondary top" },
	{  1,      1,   0,    "0%    100%   100% 23h ", "Secondary bottom" },
...
//workspace
  ...
  { -1,       0,      0,          0,  0,  PWRL,  BAR_ALIGN_LEFT,         size_workspaces,          draw_workspaces,         click_workspaces,         hover_workspaces,         "workspaces" },
	...
	{ -1,       0,      0,          0,  0,  PWRL,  BAR_ALIGN_LEFT,         size_powerline,           draw_powerline,          NULL,                     NULL,                     "powerline join" },
//systray
	{  0,       0,     6,         5,   5,   PWRL,  BAR_ALIGN_RIGHT,        size_systray,             draw_systray,            click_systray,            NULL,                     "systray" },
	{  0,       0,     0,         0,   0,   PWBL,  BAR_ALIGN_RIGHT,        size_powerline,           draw_powerline,          NULL,                     NULL,                     "powerline join" },
  ...
  //status 
	...
	{  0,       0,     0,         0,   0,   PWBL,  BAR_ALIGN_RIGHT,        size_powerline,           draw_powerline,          NULL,                     NULL,                     "powerline join" },
	{ -1,       0,     0,         5,   5,   4,     BAR_ALIGN_RIGHT,        size_status,              draw_status,             click_status,             NULL,                     "status4" },
	{  0,       0,     0,         0,   0,   PWBL,  BAR_ALIGN_RIGHT,        size_powerline,           draw_powerline,          NULL,                     NULL,                     "powerline join" },
	...
	{ -1,       0,     0,         0,   0,   PWBL,  BAR_ALIGN_RIGHT,        size_powerline,           draw_powerline,          NULL,                     NULL,                     "powerline join" },
//title
...
static const char *spcmd_r[] = {"r", "kitty", "--name", "spfmran", "-e", "ranger", NULL };
static const char *spcmd_t[] = {"t", "Telegram", "--title", "Telegram", NULL };
static const char *spcmd_v[] = {"v", "kitty", "--name", "term-pulsemixer", "-e", "pulsemixer", NULL};
...
static Key keys[] = {
  ...
  { KeyPress,    MODKEY|Alt,                   XK_e,            spawn,                  SHCMD("steam") },                                                                                                        
  ...
  { KeyPress,   MODKEY,                       XK_Print,        spawn,                  SHCMD("flameshot gui")},
  { KeyPress,   MODKEY|Alt,                   XK_Print,        spawn,                  SHCMD("flameshot full") },
  ...
  { KeyPress, MODKEY|Alt,                     XK_u,            spawn,                SHCMD("~/scripts/.dunst-vol.sh") },
  { KeyPress, MODKEY|Alt,                     XK_i,            spawn,                SHCMD("~/scripts/.dunst-vol.sh") },
  { KeyPress, MODKEY|Alt|Ctrl,                     XK_u,            spawn,                SHCMD("~/scripts/.dunst-vol.sh") },
  { KeyPress, MODKEY|Alt|Ctrl,                     XK_i,            spawn,                SHCMD("~/scripts/.dunst-vol.sh") },
  { KeyPress, MODKEY|Alt,                          XK_o,            spawn,                SHCMD("~/scripts/.metadata.sh") },
  ...
  { KeyPress, MODKEY|Alt,                     XK_l,            spawn,                SHCMD("~/scripts/.i3lock-color.sh") },
/*
...
*/
	...
	{ KeyPress,   MODKEY|Ctrl,                  XK_l,            placedir,               {.i = RIGHT } }, // move the selected client down the stack
	{ KeyPress,   MODKEY|Ctrl,                  XK_h,            placedir,               {.i = LEFT } }, // move the selected client up the stack
	...
	{ KeyPress,   MODKEY|Shift,                 XK_h,            setmfact,               {.f = -0.05} }, // decrease the size of the master area compared to the stack area(s)
	{ KeyPress,   MODKEY|Shift,                 XK_l,            setmfact,               {.f = +0.05} }, // increase the size of the master area compared to the stack area(s)
	{ KeyPress,   MODKEY|Shift,                 XK_j,            setcfact,               {.f = +0.25} }, // increase size respective to other windows within the same area
	{ KeyPress,   MODKEY|Shift,                 XK_k,            setcfact,               {.f = -0.25} }, // decrease client size respective to other windows within the same area
...
//	{ KeyPress,   MODKEY|Shift,                 XK_v,            ungroup,                {0} }, // ungroups floating clients
    ...
    { KeyPress, MODKEY|Alt,                   XK_w,            floatpos,             {.v = "50% 20% 60% 60%"} },
	...
	{ KeyPress,   MODKEY|Ctrl,                   XK_comma,        clienttomon,            {.i = -1 } }, // sends the current client to an adjacent monitor
	{ KeyPress,   MODKEY|Ctrl,                   XK_period,       clienttomon,            {.i = +1 } }, // sends the current client to an adjacent monitor
	...
	{ KeyPress,   MODKEY|Alt,                  XK_comma,        viewwsdir,              {.i = -1 } }, // view the workspace on the immediate left of current workspace (on the current monitor)
	{ KeyPress,   MODKEY|Alt,                  XK_period,       viewwsdir,              {.i = +1 } }, // view the workspace on the immediate right of current workspace (on the current monitor)
